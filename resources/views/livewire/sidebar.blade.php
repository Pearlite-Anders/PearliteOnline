<aside id="sidebar" class="fixed top-0 left-0 flex-col flex-shrink-0 hidden w-64 h-full pt-16 duration-75 md:flex">
    ...
    <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 leading-6 text-black lg:flex">
        ...
        <a
            ...
            class="inline-flex justify-center p-2 ml-4 mr-0 text-gray-900 rounded cursor-pointer hover:bg-gray-100 hover:text-gray-900"
        >
        ...
        <x-dropdown align="bottom" width="48">
            <x-slot name="trigger">
                <button
                    ...
                    class="inline-flex justify-center p-2 my-0 ml-4 mr-0 text-center text-gray-500 normal-case bg-transparent rounded cursor-pointer bg-none hover:bg-gray-100 hover:text-gray-900"
                >
