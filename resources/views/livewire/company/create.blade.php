<div>
    ...
    >
      <div class="flex items-center text-black">
        <div class="pr-3">
            <x-button.secondary href="{{ route('companies.index') }}" class="inline-flex justify-center">
    ...
    <form
        class="bottom-0 right-0 px-4 pt-8 pb-4 leading-6 text-black bg-white border-t border-b-0 border-gray-200 border-solid border-x-0"
        wire:submit="create"
    >
        @include('livewire.company.form')
        <div class="items-center text-black lg:pl-4 sm:flex">
