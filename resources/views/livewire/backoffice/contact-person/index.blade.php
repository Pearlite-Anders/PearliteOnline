    ...
    <x-index-header>
        ...
        <x-slot name="buttons">
            ...
            @can('create', App\Models\ContactPerson::class)
                <x-button.link href="{{ route('backoffice.contact-person.create', $company) }}" class="inline-flex items-center justify-center whitespace-nowrap">
                            ...
                            <x-table.cell class="text-right">
                                <div class="flex">
                                    @can('update', $contactPerson)
                                        <x-button.link
                                            href="{{ route('backoffice.contact-person.edit', [$company, $contactPerson]) }}"
