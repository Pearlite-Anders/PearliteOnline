    ...
    <x-index-header>
        ...
        <x-slot name="buttons">
            ...
            @can('create', App\Models\InternalOrder::class)
                <x-button.link href="{{ route('backoffice.internal-order.create') }}" class="inline-flex items-center justify-center whitespace-nowrap">
                            ...
                            <x-table.cell class="text-right">
                                <div class="flex">
                                    @can('update', $internalOrder)
                                        <x-button.link
                                            href="{{ route('backoffice.internal-order.edit', $internalOrder) }}"
