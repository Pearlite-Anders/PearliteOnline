<div>
    <x-form-header backlink="{{ route('backoffice.internal-order.index') }}">
        <x-slot name="title">{{ __('Edit Internal Order') }}</x-slot>
    </x-form-header>
    <form
        class="px-4 pt-8 pb-4 leading-6 border-b-0 border-gray-200 border-solid text-blackborder-t border-x-0"
        wire:submit="update"
    >
        @include('livewire.backoffice.internal-order.form')
