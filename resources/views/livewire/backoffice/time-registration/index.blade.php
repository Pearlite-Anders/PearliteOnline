    ...
    <x-index-header>
        ...
        <x-slot name="buttons">
            ...
            @can('create', App\Models\TimeRegistration::class)
                <x-button.link href="{{ route('backoffice.time-registration.create') }}" class="inline-flex items-center justify-center whitespace-nowrap">
                            ...
                            <x-table.cell class="text-right">
                                <div class="flex">
                                    @can('update', $regstration)
                                        <x-button.link
                                            href="{{ route('backoffice.time-registration.edit', $regstration) }}"
