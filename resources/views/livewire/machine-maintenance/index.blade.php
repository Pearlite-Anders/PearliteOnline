<div>
    ...
    <x-index-header>
        ...
        <x-slot name="buttons">
            ...
            @can('create', App\Models\MachineMaintenance::class)
                <x-button.link href="{{ route('machine-maintenance.create') }}" class="inline-flex items-center justify-center whitespace-nowrap">
    ...
    <div class="flex flex-col leading-6 text-black">
        <livewire:machine-maintenance.table :resource="$company" :columns="$columns" :filters="$filters" :search="$search"/>
    </div>
</div>
