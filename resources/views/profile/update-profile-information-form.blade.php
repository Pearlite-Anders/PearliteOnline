<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div x-data="{photoName: null, photoPreview: null}" class="hidden col-span-6 sm:col-span-4">
            ...
            <x-label for="photo" value="{{ __('Signature') }}" />

            <!-- Current Profile Photo -->
            <div class="mt-2" x-show="! photoPreview">
                @if($this->user->profile_photo_path)
                    <img src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->name }}" class="w-auto h-12">
                @endif
            </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            @if (Laravel\Fortify\Features::enabled(Laravel\Fortify\Features::emailVerification()) && ! $this->user->hasVerifiedEmail())
                <p class="mt-2 text-sm">
                    ...
                    <button type="button" class="text-sm text-gray-600 underline rounded-md hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500" wire:click.prevent="sendEmailVerification">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="title" type="text" class="block w-full mt-1" wire:model="state.title" required />
            <x-input-error for="name" class="mt-2" />
        </div>
    </x-slot>
